...
import PrivacyPolicyJsonLd from "./JsonLd";

export const metadata: Metadata = {
  title: "Privacy Policy - Wise Systems",
  description:
    "Our privacy policy explains how we collect, use, and protect your personal data when using our services. Learn about your rights and how to contact us.",
  alternates: {
  ...
  openGraph: {
    title: "Privacy Policy - Wise Systems",
    description:
      "Learn how Wise Systems protects your personal data and privacy rights.",
    url: "/privacy-policy",
    type: "article",
    publishedTime: "2024-08-21T00:00:00Z",
    modifiedTime: "2024-08-21T00:00:00Z",
  },
};
      ...
      <div className="p-4 mx-auto max-w-5xl lg:p-16">
        <div>
          ...
          >
            ...
            <h3 className="text-2xl font-bold dark:text-white">Definitions</h3>
            <p className="text-gray-600 dark:text-gray-400">
            ...
            <ul className="max-w-2xl space-y-4 text-gray-700 list-disc list-oustide dark:text-gray-400">
              ...
              <li>
                <span>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Wise Systems LLC,
                  2002 E Gann Hill Dr, Cedar Park TX 78613.
                </span>
              </li>
              <li>
                <span>
              ...
              <li>
                <span>
                  <strong>Website</strong> refers to {BRAND_NAME}, accessible
                  from{" "}
                  <a
                    href="https://wisepilot.io"
            ...
            <h4 className="text-xl font-bold dark:text-white">Personal Data</h4>
            <p className="text-gray-600 dark:text-gray-400">
            ...
            <ul className="max-w-2xl space-y-4 text-gray-700 list-disc list-oustide dark:text-gray-400">
              ...
              <li>
                <p className="text-gray-600 dark:text-gray-400">Usage Data</p>
              </li>
            </ul>
            <h4 className="text-xl font-bold dark:text-white">Usage Data</h4>
            <p className="text-gray-600 dark:text-gray-400">
