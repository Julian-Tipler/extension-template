...
export const BEST_VALUE_TEXT = "Best Value"; // "Most popular"
...
// CALL TO ACTION
export const CALL_TO_ACTION = "Buy " + BRAND_NAME + " now!";
export const CALL_TO_ACTION_DESCRIPTION =
  "We are here to help you get started with " +
  SERVICE +
...
// "/" page
export const DESCRIPTION_OF_HOMEPAGE_CONTENT =
  "A brief description of your homepage content";
